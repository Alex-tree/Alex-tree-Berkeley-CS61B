...
public class TestMyTrieSet {
    ...
    public void sanityLongestTest() {
        ...
        String prefix = t.longestPrefixOf("samt");
        assertEquals("sa",prefix);
        prefix=t.longestPrefixOf("awls");
        assertEquals("",prefix);
        t.add("hellowq");
        prefix=t.longestPrefixOf("hello");
        assertEquals("hell",prefix);
    }

...
public class Plip extends Creature {
    ...
    private double replose=0.5;
    private double offspring=0.5;
    ...
    public Plip replicate() {
        double babyPlip=offspring*energy;
        energy*=replose;
        return new Plip(babyPlip);
    }
    ...
    public Action chooseAction(Map<Direction, Occupant> neighbors) {
        ...
        // (Google: Enhanced for-loop over keys of NEIGHBORS?)
           ...
           if(this.energy>=1.0){
               int k=new Random().nextInt(emptyNeighbors.size());//yield 0(inclusive) to emptyNeighbors.size()(exclusive)
               for(int i =0;i<k-1;i++){

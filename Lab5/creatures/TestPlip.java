...
public class TestPlip {
    ...
    public void testReplicate() {
        ...
        assertEquals(new Color(99,159,76),pOffspring.color());
        Plip pOfffspring=p.replicate();
        assertEquals(0.5,p.energy(),0.01);
        assertEquals(new Color(99,111,76),p.color());
        assertEquals(0.5,pOfffspring.energy(),0.01);
        assertEquals(new Color(99,111,76),p.color());
    }
